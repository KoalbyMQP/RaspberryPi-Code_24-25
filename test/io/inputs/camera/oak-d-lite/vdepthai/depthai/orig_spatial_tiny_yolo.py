...
# Get argument first
nnBlobPath = "yolo-v4-tiny-tf_openvino_2021.4_6shave.blob"
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        for detection in detections:
            ...
            cv2.putText(frame, "{:.2f}".format(detection.confidence), (x1 + 10, y1 + 35), cv2.FONT_HERSHEY_TRIPLEX, 0.5, 255)
            ...
            cv2.putText(frame, f"Width: {int(xmax-xmin)/1000} m", (x1 + 10, y1 + 95), cv2.FONT_HERSHEY_TRIPLEX, 0.5, 255)
            cv2.putText(frame, f"Height: {int(ymax-ymin)/1000} m", (x1 + 10, y1 + 110), cv2.FONT_HERSHEY_TRIPLEX, 0.5, 255)
