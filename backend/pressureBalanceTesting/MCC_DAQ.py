...
from daqhats import hat_list, mcc118, mcc128, OptionFlags, HatIDs, TriggerModes,HatError, AnalogInputMode, AnalogInputRange
...
class MCC():
    def __init__(self, device_count_128=1, device_count_118=1, master_128=0, 
        ...
        self.address_128 = address_128
        self.address_118 = address_118
    ...
    def set_hats_ready(self):
        ...
        #hats_128 = hat_list(filter_by_id=self.device_count_128)
        #hats_118 = hat_list(filter_by_id=self.device_count_118)
        
        #number_of_hats_128 = self.device_count_128
        ...
        #print(hats_128)
        for i in range(self.device_count_128):
            selected_hats_128.append(mcc128(self.address_128[i]))
        for i in range(self.device_count_118):
            selected_hats_118.append(mcc118(self.address_118[i]))
        ...
        for i in range(self.device_count_128):
            self.hats_128.append(mcc128(self.address_128[i]))
            #self.hats_118 = select_hat_devices(HatIDs.MCC_118, self.device_count_118)
        for i in range(self.device_count_118):
            self.hats_118.append(mcc128(self.address_118[i]))
        ...
        self.hats_128[self.master_128].trigger_mode(self.trigger_mode)
    ...
    def set_hats_scan_start(self):
        ...
        for i, hat in enumerate(self.hats_128):
            chan_mask = chan_list_to_mask(self.chans_128[i])
    ...
    def get_data(self, samples_to_read = 1, timeout = 5):
        ...
        for i, hat in enumerate(self.hats_128):
            ...
            is_running_sample &= read_result.running
