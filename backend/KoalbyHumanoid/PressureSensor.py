...
class ForceManager():
    ...
    def pressurePerSensor(self):
        ...
        pressures[0] = data["RTR"][2]
        pressures[1] = data["RTL"][2]
        pressures[2] = data["RBR"][2]
        pressures[3] = data["RBL"][2]
        pressures[4] = data["LTR"][2]
        pressures[5] = data["LTL"][2]
        pressures[6] = data["LBR"][2]
        pressures[7] = data["LBL"][2]
