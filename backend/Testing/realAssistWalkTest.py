...
def createTrajectories(rightLeg, leftLeg, rightArm, leftArm):
    ...
    rightOffset = [0, 0, WAIST_OFFSET, 0, -ANKLE_OFFSET]
    leftOffset = [0, 0, -WAIST_OFFSET, 0, ANKLE_OFFSET]
...
def main():
    ...
    while True:
        ...
        # robot.motors[3].target = (rArm_points[2], 'P') #pos
        # robot.motors[4].target = (rArm_points[3], 'P')

        # # Left Arm
        # robot.motors[5].target = (lArm_points[0], 'P')
        # robot.motors[6].target = (lArm_points[1], 'P')
        # robot.motors[8].target = (lArm_points[2], 'P')#neg
        # robot.motors[9].target = (lArm_points[3], 'P') 
