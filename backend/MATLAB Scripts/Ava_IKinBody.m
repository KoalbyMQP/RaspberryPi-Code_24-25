...
% 0.000000, 1.000000, 0.000000, -467.159087 + deltaY;
% 0.000000, -0.000000, 1.000000, 8.587029 + deltaZ;
% 0.000000, 0.000000, 0.000000, 1.000000]
% thetalist0 =[deg2rad(0); deg2rad(0); deg2rad(-5); deg2rad(-10); deg2rad(5)];
...
M = [[1, 0, 0, -22.63]; [0, 1, 0, -468.74]; [0, 0, 1, 12.74]; [0, 0, 0, 1]];
T =  [1.000000, 0.000000, 0.000000, -22.630000 + deltaX;
0.000000, 0.984808, -0.173648, -471.687467 + deltaY;
0.000000, 0.173648, 0.984808, 2.066641 + deltaZ;
0.000000, 0.000000, 0.000000, 1.000000];
thetalist0 =[deg2rad(0); deg2rad(0); deg2rad(5); deg2rad(10); deg2rad(5)];
