...
0.000000, 1.000000, 0.000000, -468.344584 + deltaY;
0.000000, 0.000000, 1.000000, 10.661536 + deltaZ;
0.000000, 0.000000, 0.000000, 1.000000]
thetalist0 =[deg2rad(0); deg2rad(0); deg2rad(-2.5); deg2rad(-5); deg2rad(2.5)];
...
% M = [[1, 0, 0, -22.63]; [0, 1, 0, -468.74]; [0, 0, 1, 12.74]; [0, 0, 0, 1]];
% T =  [1.000000, 0.000000, 0.000000, -22.630000 + deltaX;
% 0.000000, 0.996195, -0.087156, -470.751116 + deltaY;
% 0.000000, 0.087156, 0.996195, 7.500199 + deltaZ;
% 0.000000, 0.000000, 0.000000, 1.000000];
% thetalist0 =[deg2rad(0); deg2rad(0); deg2rad(2.5); deg2rad(5); deg2rad(-2.5)];
...
% T =  [-0.000000, -1.000000, 0.000000, -16.500000 + deltaX;
